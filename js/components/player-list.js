...
export const STAR_ICON = `<svg width="10" height="10" viewBox="0 0 10 10" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  <path d="M5 1l1.18 2.39L9 3.82 7 5.76l.47 2.74L5 7.27 2.53 8.5 3 5.76 1 3.82l2.82-.43L5 1z"/>
</svg>`;

export const SKULL_ICON = `<svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
export function formatBirthday(p) {
