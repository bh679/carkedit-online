...
export const PAGES = [
  ...
  { path: 'branch-manager',       label: 'Branch Manager',        defaultMinRole: 'QA',     category: 'admin'  },
  ...
  { path: 'deploying',            label: 'Deploying',             defaultMinRole: 'QA',     category: 'admin'  },
  ...
  { path: 'stats-games',          label: 'Game Stats',            defaultMinRole: 'QA',     category: 'admin'  },
  { path: 'stats-surveys',        label: 'Survey Stats',          defaultMinRole: 'QA',     category: 'admin'  },
